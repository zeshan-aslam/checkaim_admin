                ...
                <div class='sapn12'>
                    <div class="widget">
                        ...
                        <div class="widget-body" style="padding: 32px 60px;">
                            <form action="{{ url('GDPRLegislation_update/'.$policy_edit->id) }}" method="POST" enctype="multipart/form-data"
                                class='form-horizontal'>
                                @csrf
                                <div class="control-group">
                                    <label class="control-label"> Heading</label>
                                    <div class="controls">
                                        <input class="span6" name="title" placeholder="Enter title" type="text" value="{{$policy_edit->title}}"
                                            required />
                                    </div>
                                    <div class="controls">
                                        @error('title')
