                ...
                <div class='sapn12'>
                    <div class="widget">
                        ...
                        <div class="widget-body" style="padding: 32px 60px;">
                            <form action="{{ url('/TermsConditions') }}" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="span6" name="heading" placeholder="Enter title" type="text"
                                            required />
                                    </div>
                                    <div class="controls">
                                        @error('heading')
                        ...
                        <table id='sliderView' class=" table table-striped table-hover table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ url('TermsConditions-edit/'.$data->id) }}" type="button" class="btn btn-primary btn-lg">Edit</a>
                                        <a href="{{ url('TermsConditions/'.$data->id) }}" type="button" class="btn btn-danger btn-lg">Delete</a>
                                    </td>
                                </tr>
                            @endforeach  
                            </tbody>
