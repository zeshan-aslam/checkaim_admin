                        ...
                        <table id='sliderView' class=" table table-striped table-hover table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ url('FAQs-edit/'.$data->id) }}" type="button" class="btn btn-primary btn-lg">Edit</a>
                                        <a href="{{ url('FAQs/'.$data->id) }}" type="button" class="btn btn-danger btn-lg">Delete</a>
                                    </td>
                                </tr>
                            @endforeach  
                            </tbody>
