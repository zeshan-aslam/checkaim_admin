                ...
                <div class='sapn12'>
                    <div class="widget">
                        ...
                        <div class="widget-body" style="padding: 32px 60px;">
                            <form action="{{ url('/PrivacyPolicy') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <tbody>
                                @foreach ($shows as $data)
                                    <tr>
                                        ...
                                        <td><a href="{{ url('PrivacyPolicy-edit/'.$data->id) }}" type="button" class="btn btn-primary btn-lg">Edit</a>
                                            <a href="{{ url('PrivacyPolicy/'.$data->id) }}" type="button" class="btn btn-danger btn-lg">Delete</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
