                ...
                <div class='sapn12'>
                    <div class="widget">
                        ...
                        <div class="widget-body" style="padding: 32px 60px;">
                           <form action="{{ url('/PrivacyPolicy') }}" method="POST"
                                enctype="multipart/form-data" class='form-horizontal'>
                                @csrf
                                <div class="control-group">
                                    <label class="control-label"> Heading</label>
                                    <div class="controls">
                                        <input class="span6" name="heading" placeholder="Enter Heading" type="text" required/>
                                    </div>
                                    <div class="controls">
                                        @error('heading')
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea class="span6" name="text" placeholder="Enter Text" type="text" required></textarea>
                                    </div>
                                    <div class="controls">
                                        @error('text')
                                            <div class="alert alert-danger span6" style="margin-top: 5px;">{{ $message }}
